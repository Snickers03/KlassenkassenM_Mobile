...
class DatabaseService {
  ...
  Future updateStudentData(String uid, String name, String vorname,
      double balance, String userID) async {
    //print(this.uid);
  ...
  Future updatePaymentData(DateTime date, String reason, double amount,
      List<String> selectedStudents) async {
  ...
  Future deleteStudents(List<Student> selection) async {
    //do this you kek
